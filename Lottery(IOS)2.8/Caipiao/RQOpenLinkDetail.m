...
@implementation RQOpenLinkDetail
...
- (void)parse:(NSDictionary*)result
{
    ...
    [keys enumerateObjectsUsingBlock:^(NSDictionary* obj, NSUInteger idx, BOOL *stop) {
        OpenLinkDetailObject *o = [[OpenLinkDetailObject alloc]init];
    ...
    [arr enumerateObjectsUsingBlock:^(NSMutableArray* obj, NSUInteger idx, BOOL *stop)
    {
        ...
        [obj enumerateObjectsUsingBlock:^(OpenLinkDetailObject* obj, NSUInteger idx, BOOL *stop)
        {
            if (obj.lot_name) {
...
@implementation OpenLinkDetailObject
