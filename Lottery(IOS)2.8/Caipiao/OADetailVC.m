...
@interface OADetailVC ()<UITableViewDelegate>
...
-(void)requestData
{
    RQOpenLinkDetail *rq = [[RQOpenLinkDetail alloc]init];
    rq.linkid =  _object.linkid;
    self.rq = rq;
     __block OADetailVC *blockself = self;
    [rq startPostWithBlock:^(RQOpenLinkDetail* rq_, NSError *error_, id rqSender_) {
...
{
    RQOpenLinkDetail *rq = (RQOpenLinkDetail*)self.rq;
