...
//  Caipiao
//
//  Created by danal-rich on 8/1/14.
...
//                grid.image = [UIImage imageNamed:@"NumberPad-back.png"];
                grid.image = [UIImage imageWithContentsOfFile:MSResPath(@"NumberPad-back.png")];
            }
            grid.active = NO;
...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self){
        ...
        _numberLabel.backgroundColor = _textLabel.backgroundColor = self.backgroundColor;
    }
    return self;
}
