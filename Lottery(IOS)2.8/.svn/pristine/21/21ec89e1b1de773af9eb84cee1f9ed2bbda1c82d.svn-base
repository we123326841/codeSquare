...
#import "RQAgentSetting.h"

@implementation RQAgentSetting
-(void)prepare
{
...
- (void)parse:(NSDictionary*)result
{
    ...
    [keys enumerateObjectsUsingBlock:^(NSDictionary* obj, NSUInteger idx, BOOL *stop) {
        AgentSettingObject *o = [[AgentSettingObject alloc]init];
    ...
    [arr enumerateObjectsUsingBlock:^(NSMutableArray* obj, NSUInteger idx, BOOL *stop)
     {
         ...
         [obj enumerateObjectsUsingBlock:^(AgentSettingObject* obj, NSUInteger idx, BOOL *stop)
          {
              if (obj.lot_name) {
...
@implementation AgentSettingObject
